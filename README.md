...
_**Note**_:_In order to view the styling applied on this application, ensure you have SASS installed via node (##### `npm start`)._This will compile your SASS into CSS after cloning the project
