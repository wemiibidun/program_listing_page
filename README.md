...
_**Note**_: _In order to view the styling applied on this application, ensure you have SASS installed via node using_ `npm install --save node sass`. _This will compile your SASS into CSS after cloning the project_
